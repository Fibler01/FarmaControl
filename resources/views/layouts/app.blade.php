    ...
    <div id="app">
        <nav class="navbar cabecalho navbar-expand-lg navbar-dark bg-blue">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="{{route('PesquisarProdutosController@getPesquisa')}}">Produtos</a>
                <a class="dropdown-item" href="{{route('PesquisarLaboratorioController@getPesquisa')}}">Laboratórios</a>
                <a class="dropdown-item" href="{{route('PesquisarFornecedoresController@getPesquisa')}}">Fornecedores</a>
                <a class="dropdown-item" href="{{route('PesquisarClienteController@getPesquisa')}}">Clientes</a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: white">
                    Gerenciar
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="{{route('EntradaProdutosController@getEntradaProdutos')}}">Entrada de Produtos</a>
            </li>
